                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <input required="true" type="text" class="form-control" id="usr" name="fullname"
                            value="<?=$s_fullname?>" readonly>
                    </div>
                    <div class="form-group">
                        <label for="usr">Nhiệm vụ:</label>
                        <input type="text" class="form-control" id="usr" name="nhiemVu" value="<?=$s_nhiemVu?>" readonly>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" class="form-control" id="usr" name="hoanThanh" value="<?=$s_hoanThanh?>" readonly>
                    </div>
                    <div class="form-group">
