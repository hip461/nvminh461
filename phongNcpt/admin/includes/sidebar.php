...
<div id="sidebar-container" class="sidebar-expanded d-none d-md-block">
    ...
    <ul class="list-group">
        ...
        <div id='submenu2' class="collapse sidebar-submenu">
            <a href="./admin.php?id=<?php echo $id?>" class="list-group-item list-group-item-action bg-dark text-white">
        ...
        <a href="./viewUser.php" class="bg-dark list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-start align-items-center">
                <span class="fa fa-user fa-fw mr-3"></span>
                <span class="menu-collapsed">Quản lý nhân viên</span>
                <span class="submenu-icon ml-auto"></span>
            </div>
        </a>
        <a href="./nhiemvu.php" class="bg-dark list-group-item list-group-item-action">
            <div class="d-flex w-100 justify-content-start align-items-center">
                ...
                <span class="menu-collapsed">Phân công nhiệm vụ</span>
            </div>
        </a>
        <!-- Separator with title -->
