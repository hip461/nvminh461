            ...
            <div class="col">
                ...
                <table class="table table-success table-striped-columns">
                    ...
                    <tbody>
						...
						$sql = "select * from tbl_nhiemvu where fullname like '%$tim_kiem%' order by id DESC limit $so_dong_tren_trang offset $bo_qua";
						...
						foreach ($khach as $std) {
                            ...
                            <td>'.$std['hoanThanh'].'</td>
                            <td>'.$std['duKien'].'</td>
							<td><button class="btn btn-success" onclick=\'window.open("baocao.php?id='.$std['id'].'","_self")\'>Đánh giá</button></td>';

						}
					?>
                    </tbody>
                </table>
                <button class="btn btn-success" onclick="window.open('baocao.php', '_self')">Phân công nhiệm vụ mới</button>
            </div><!-- Main Col END -->
        </div>
    </div>
